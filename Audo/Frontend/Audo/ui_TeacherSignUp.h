...
"border-radius: 16px;"));
        ...
        SignInButton->setGeometry(QRect(690, 680, 81, 31));
        QFont font1;
...
"border-radius: 16px;"));
        ...
        SignInType->setGeometry(QRect(320, 150, 101, 61));
        QFont font3;
...
"border-radius: 16px;"));
        ...
        SignInTitle->setGeometry(QRect(320, 120, 121, 61));
        QFont font4;
...
""));
        ...
        ClassCodeFrame->setGeometry(QRect(340, 500, 581, 71));
