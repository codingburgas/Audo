...
""));
        ...
        SignInButton->setGeometry(QRect(680, 670, 81, 31));
        QFont font3;
...
"color: #AAAAAA;"));
        ...
        Warning->setGeometry(QRect(350, 190, 541, 31));
...
"color: rgb(170, 0, 0);"));
        School = new QTextEdit(StudentSignUp);
        School->setObjectName("School");
        School->setGeometry(QRect(350, 510, 571, 41));
        School->setFont(font2);
...
"border: none;\n"
"color: #777777;"));
        SchoolFrame = new QLabel(StudentSignUp);
        SchoolFrame->setObjectName("SchoolFrame");
        SchoolFrame->setGeometry(QRect(340, 490, 581, 71));
...
"border-radius: 16px;"));
    ...
    void retranslateUi(QWidget *StudentSignUp)
    {
        ...
        School->setPlaceholderText(QCoreApplication::translate("StudentSignUp", "School", nullptr));
